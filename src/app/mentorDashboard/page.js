    ...
    <div className="lg:pl-64 md:pl-64 sm:pl-64 pl-16 py-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg mt-6">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600">
            I offer a mix of one-on-one sessions, group coaching, and hands-on coding workshops.
            My approach focuses on real-world application, empowering mentees with the skills and
